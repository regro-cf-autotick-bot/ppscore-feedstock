...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ppscore-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11357&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ppscore-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ppscore` can be installed with:

```
conda install ppscore
```

It is possible to list all of the versions of `ppscore` available on your platform with:
